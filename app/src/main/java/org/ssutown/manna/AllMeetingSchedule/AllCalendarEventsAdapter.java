...
public class AllCalendarEventsAdapter extends BaseAdapter {
    static ArrayList<AllCalendarEventItem> listViewItemList = new ArrayList<AllCalendarEventItem>();

    public AllCalendarEventsAdapter(){} @Override
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final AllCalendarEventItem listViewItem = listViewItemList.get(position);
...
*/
    ...
    public void addItem(String title, String about) {
        AllCalendarEventItem item = new AllCalendarEventItem(title, about);
