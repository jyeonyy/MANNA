 ...
 */
public class AllSavedEventsAdapter extends BaseAdapter {
    // Variables
    ...
    // Constructor
    public AllSavedEventsAdapter(Context context) {
        mContext = context;
    }

    @Override
    public int getCount() {
        if (AllMeetingCalendarFragment.mNumEventsOnDay != 0 || AllMeetingCalendarFragment.mNumEventsOnDay != -1) {
            return AllMeetingCalendarFragment.mNumEventsOnDay;
        }
