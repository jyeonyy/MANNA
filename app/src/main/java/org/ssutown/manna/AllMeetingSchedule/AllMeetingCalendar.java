...
public class AllMeetingCalendar {
    ...
    private static void refreshCalendar(TextView monthTextView, GridView calendarGridView,
                                        AllMeetingCalendarAdapter meetingCalendarAdapter, int month, int year) {
        ...
        if (AllMeetingCalendarFragment.mSavedEventsAdapter != null) {
            AllMeetingCalendarFragment.mNumEventsOnDay = -1;
            AllMeetingCalendarFragment.mSavedEventsAdapter.notifyDataSetChanged();
            Log.d("EVENTS_ADAPTER", "refresh");
        }

        AllMeetingCalendarFragment.getSavedEventsForCurrentMonth();
    ...
    protected static void previousOnClick(ImageView previousImageView, TextView monthTextView,
                                          GridView calendarGridView, AllMeetingCalendarAdapter meetingCalendarAdapter) {
    ...
    protected static void nextOnClick(ImageView nextImageView, TextView monthTextView,
                                      ...
                                      AllMeetingCalendarAdapter meetingCalendarAdapter) {
    ...
    protected static void selectCalendarDay(AllMeetingCalendarAdapter meetingCalendarAdapter, int position) {
